...
A lightweight vanilla HTML, CSS, and JavaScript portfolio with a video intro and minimalist landing page.

## Files

- `index.html` - intro markup and minimalist portfolio content
- `styles.css` - responsive portfolio layout and theme
